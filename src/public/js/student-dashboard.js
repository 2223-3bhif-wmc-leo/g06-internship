...
function showInternshipDetails(internship) {
    return __awaiter(this, void 0, void 0, function () {
        var previousInternshipCard, internshipCard, internshipDetails, internshipDetailsContent, header, descriptionHeader, descriptionParagraph, requirementsHeader, requirementsParagraph, durationHeader, duractionParagraph, firma, payHeader, payParagraph, applyButtonContainer, applyButton, info;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    internshipDetailsContent.append(header, descriptionHeader, descriptionParagraph, requirementsHeader, requirementsParagraph, durationHeader, duractionParagraph, payHeader, payParagraph, applyButtonContainer, info);
